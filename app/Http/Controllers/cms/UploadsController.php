...
class UploadsController extends BaseController {
    ...
    public function upload(Request $request) {
        ...
        if($request->hasFile('upload')) {
            ...
            if ( !in_array($uploaded_file->getMimeType(),  ['image/jpeg', 'image/gif', 'image/png', 'application/pdf']))
            {
                return "Invalid document type";
            }

            if ( !in_array($uploaded_file->getClientOriginalExtension(),  ['jpeg', 'gif', 'png', 'pdf']))
            {
                return "Invalid document type";
            }
