...
class BaseSiteController extends Controller {
    ...
    public function __construct()
    {
        ...
        View::share('social_links', SocialLink::orderBy('position', 'ASC')->take(7)->get());

        // View::share('sponsorLinks', Sponsor::orderBy('id', 'ASC')->take(7)->get());

        View::share('relatedLinks', RelatedLink::orderBy('position', 'ASC')->take(7)->get());

        View::share('importantLinks', ImportantLink::orderBy('position', 'ASC')->take(7)->get());

        View::share('background', Background::orderBy('id','DESC')->first());

        // View::share('howDoIs', HowDoI::where('active', true)->take(4)->get());

        View::share('news_list', News::orderBy('id', 'DESC')->where('active','=',1)->take(4)->get());

        // View::share('recent_events', Events::orderBy('id', 'DESC')->where('active','=',1)->limit(3)->get());

        View::share('recent_announcements', Announcement::orderBy('id', 'DESC')->where('active','=',1)->take(5)->get());
        
        View::share('online_services', OnlineService::orderBy('position', 'ASC')->where('active','=',1)->take(8)->get());
        ...
        View::share('quotations', Quotation::orderBy('id', 'DESC')->where('active','=',1)->take(5)->get());
        View::share('course_categories', CourseCategory::orderBy('id', 'DESC')->get());
