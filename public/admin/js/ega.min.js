...
function togglemenu() {
    ...
    0 == $(".ega-navbar").hasClass("theme-horizontal") && (e <= 1200 && e >= 992 && $(".ega-navbar").addClass("navbar-collapsed"), e < 992 && $(".ega-navbar").removeClass("navbar-collapsed"))
}
...
$(document).ready(function() {
    ...
    if ($('[data-toggle="tooltip"]').tooltip(), $('[data-toggle="popover"]').popover(), $(".to-do-list input[type=checkbox]").on("click", function() {
            ...
            $(".ega-navbar").toggleClass("navbar-collapsed")
            ...
            var e = $(this).val().toLowerCase(),
                s = $(this).val().length;
            $(".ega-inner-navbar > li").each(function() {
                var d = $(this).attr("data-username");
                if (d) var i = d.toLowerCase();
                if (i) {
                    -1 !== i.indexOf(e) ? $(this).show() : $(this).hide(), s > 0 ? $(".ega-menu-caption").hide() : $(".ega-menu-caption").show()
                }
            })
            ...
            width: "100%"
        }), !$(".ega-navbar").hasClass("theme-horizontal")) {
        var o = $(window)[0].innerWidth;
        o < 992 || $(".ega-navbar").hasClass("menupos-static") ? $(".navbar-content").slimScroll({
            setTop: "1px",
            size: "5px",
            wheelStep: 10,
            touchScrollStep: 90,
...
$(window).scroll(function() {
    ...
    var s = (this.attr("id"), {
        ...
        d = {
            ...
            HandleSubMenuTrigger: function() {
                var s = $(window),
                    d = s.width();
                if (1 == $(".ega-navbar").hasClass("theme-horizontal"))
                    if (d >= 768) {
                        var i = $(".ega-inner-navbar .ega-submenu > li.ega-hasmenu");
                        i.off("click").off("mouseenter mouseleave").hover(function() {
                            $(this).addClass("ega-trigger")
                        }, function() {
                            $(this).removeClass("ega-trigger")
                        })
                    } else {
                        var i = $(".ega-inner-navbar .ega-submenu > li > .ega-submenu > li");
                        i.off("mouseenter mouseleave").off("click").on("click", function() {
                            0 === $(this).closest(".ega-submenu").length ? $(this).hasClass("ega-trigger") ? ($(this).removeClass("ega-trigger"), $(this).children(".ega-submenu").slideUp()) : ($(".ega-submenu > li > .ega-submenu > li.ega-trigger").children(".ega-submenu").slideUp(), $(this).closest(".ega-inner-navbar").find("li.ega-trigger").removeClass("ega-trigger"), $(this).addClass("ega-trigger"), $(this).children(".ega-submenu").slideDown()) : $(this).hasClass("ega-trigger") ? ($(this).removeClass("ega-trigger"), $(this).children(".ega-submenu").slideUp()) : ($(".ega-submenu > li > .ega-submenu > li.ega-trigger").children(".ega-submenu").slideUp(), $(this).closest(".ega-submenu").find("li.ega-trigger").removeClass("ega-trigger"), $(this).addClass("ega-trigger"), $(this).children(".ega-submenu").slideDown())
                        }), $(".ega-inner-navbar .ega-submenu > li > .ega-submenu > li").on("click", function(e) {
                            e.stopPropagation(), alert("click call"), 0 === $(this).closest(".ega-submenu").length ? $(this).hasClass("ega-trigger") ? ($(this).removeClass("ega-trigger"), $(this).children(".ega-submenu").slideUp()) : ($(".ega-hasmenu li.ega-trigger").children(".ega-submenu").slideUp(), $(this).closest(".ega-inner-navbar").find("li.ega-trigger").removeClass("ega-trigger"), $(this).addClass("ega-trigger"), $(this).children(".ega-submenu").slideDown()) : $(this).hasClass("ega-trigger") ? ($(this).removeClass("ega-trigger"), $(this).children(".ega-submenu").slideUp()) : ($(".ega-hasmenu li.ega-trigger").children(".ega-submenu").slideUp(), $(this).closest(".ega-submenu").find("li.ega-trigger").removeClass("ega-trigger"), $(this).addClass("ega-trigger"), $(this).children(".ega-submenu").slideDown())
                        })
                    } switch (e.SubMenuTrigger) {
                    case "click":
                        $(".ega-navbar .ega-hasmenu").removeClass("is-hover"), $(".ega-inner-navbar .ega-submenu > li > .ega-submenu > li").on("click", function(e) {
                            e.stopPropagation(), 0 === $(this).closest(".ega-submenu").length ? $(this).hasClass("ega-trigger") ? ($(this).removeClass("ega-trigger"), $(this).children(".ega-submenu").slideUp()) : ($(".ega-submenu > li > .ega-submenu > li.ega-trigger").children(".ega-submenu").slideUp(), $(this).closest(".ega-inner-navbar").find("li.ega-trigger").removeClass("ega-trigger"), $(this).addClass("ega-trigger"), $(this).children(".ega-submenu").slideDown()) : $(this).hasClass("ega-trigger") ? ($(this).removeClass("ega-trigger"), $(this).children(".ega-submenu").slideUp()) : ($(".ega-submenu > li > .ega-submenu > li.ega-trigger").children(".ega-submenu").slideUp(), $(this).closest(".ega-submenu").find("li.ega-trigger").removeClass("ega-trigger"), $(this).addClass("ega-trigger"), $(this).children(".ega-submenu").slideDown())
                        }), $(".ega-submenu > li").on("click", function(e) {
                            e.stopPropagation(), 0 === $(this).closest(".ega-submenu").length ? $(this).hasClass("ega-trigger") ? ($(this).removeClass("ega-trigger"), $(this).children(".ega-submenu").slideUp()) : ($(".ega-hasmenu li.ega-trigger").children(".ega-submenu").slideUp(), $(this).closest(".ega-inner-navbar").find("li.ega-trigger").removeClass("ega-trigger"), $(this).addClass("ega-trigger"), $(this).children(".ega-submenu").slideDown()) : $(this).hasClass("ega-trigger") ? ($(this).removeClass("ega-trigger"), $(this).children(".ega-submenu").slideUp()) : ($(".ega-hasmenu li.ega-trigger").children(".ega-submenu").slideUp(), $(this).closest(".ega-submenu").find("li.ega-trigger").removeClass("ega-trigger"), $(this).addClass("ega-trigger"), $(this).children(".ega-submenu").slideDown())
                        })
                }
            },
            HandleMenuTrigger: function() {
                var s = $(window),
                    d = s.width();
                if (1 == $(".ega-navbar").hasClass("theme-horizontal")) {
                    var i = $(".ega-inner-navbar > li");
                    d >= 768 ? i.off("click").off("mouseenter mouseleave").hover(function() {
                        if ($(this).addClass("ega-trigger"), $(".ega-submenu", this).length) {
                            var e = $(".ega-submenu:first", this),
                                s = e.offset(),
                                d = s.left,
                                i = e.width();
                            $(window).height();
                        ...
                        $(this).hasClass("ega-trigger") ? ($(this).removeClass("ega-trigger"), $(this).children(".ega-submenu").slideUp()) : ($("li.ega-trigger").children(".ega-submenu").slideUp(), $(this).closest(".ega-inner-navbar").find("li.ega-trigger").removeClass("ega-trigger"), $(this).addClass("ega-trigger"), $(this).children(".ega-submenu").slideDown())
                    })
                }
                switch (e.MenuTrigger) {
                    case "click":
                        $(".ega-navbar").removeClass("is-hover"), $(".ega-inner-navbar > li:not(.ega-menu-caption) ").on("click", function() {
                            $(this).hasClass("ega-trigger") ? ($(this).removeClass("ega-trigger"), $(this).children(".ega-submenu").slideUp()) : ($("li.ega-trigger").children(".ega-submenu").slideUp(), $(this).closest(".ega-inner-navbar").find("li.ega-trigger").removeClass("ega-trigger"), $(this).addClass("ega-trigger"), $(this).children(".ega-submenu").slideDown())
                        })
                }
            },
            HandleOffset: function() {
                switch (e.themelayout) {
                    case "horizontal":
                        "hover" === e.SubMenuTrigger ? $("li.ega-hasmenu").on("mouseenter mouseleave", function(e) {
                            if ($(".ega-submenu", this).length) {
                                var s = $(".ega-submenu:first", this),
                                    d = s.offset(),
                                    i = d.left,
                                    o = s.width();
                                $(window).height();
                        ...
                        }) : $("li.ega-hasmenu").on("click", function(e) {
                            if (e.preventDefault(), $(".ega-submenu", this).length) {
                                var s = $(".ega-submenu:first", this),
                                    d = s.offset(),
                                    i = d.left,
                                    o = s.width();
    ...
    $(window)[0].innerWidth < 992 && ($(".ega-navbar").toggleClass("mob-open"), e.stopPropagation())
}), $(window).ready(function() {
    var e = $(window)[0].innerWidth;
    $(".ega-navbar").on("click tap", function(e) {
        e.stopPropagation()
    }), $(".ega-main-container,.ega-header").on("click", function() {
        e < 992 && 1 == $(".ega-navbar").hasClass("mob-open") && ($(".ega-navbar").removeClass("mob-open"), $("#mobile-collapse,#mobile-collapse1").removeClass("on"))
