! function(e, t) {
    ...
    function h(e) {
        ...
        if (f || h) {
            var m = t(e);
            f -= c(m, "x"), h -= c(m, "y"), i.width -= f, i.height -= h
        }
        return d(i)
    }
    ...
    function E(e, t, n) {
        ...
        var r = T(e),
            ...
            u = i ? "height" : "width",
            l = i ? "width" : "height";
        return o[a] = t[a] + t[u] / 2 - r[u] / 2, o[s] = n === s ? t[s] - r[l] : t[C(s)], o
    }
    ...
    function N() {
        if (!this.state.isDestroyed) {
            ...
            e.offsets.reference = x(this.state, this.popper, this.reference), e.placement = w(this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), e.originalPlacement = e.placement, e.offsets.popper = E(this.popper, e.offsets.reference, e.placement), e.offsets.popper.position = "absolute", e = D(this.modifiers, e), this.state.isCreated ? this.options.onUpdate(e) : (this.state.isCreated = !0, this.options.onCreate(e))
        }
    }
    ...
    function O(e, t, n, o) {
        ...
        a.addEventListener(t, n, {
            passive: !0
        }), i || O(r(a.parentNode), t, n, o), o.push(a)
    }
    ...
    function H(e, t, n, o) {
        ...
        var i = r(e);
        return O(i, "scroll", n.updateBound, n.scrollParents), n.scrollElement = i, n.eventsEnabled = !0, n
    }
    ...
    function B(e, t) {
        Object.keys(t).forEach(function(n) {
            var r = ""; - 1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(n) && R(t[n]) && (r = "px"), e.style[n] = t[n] + r
        })
    }
    ...
    function Y(e, t) {
        var n, r = t.offset,
            ...
            s = i.reference,
            u = o.split("-")[0];
        return n = R(+r) ? [+r, 0] : _(r, a, s, u), "left" === u ? (a.top += n[0], a.left -= n[1]) : "right" === u ? (a.top += n[0], a.left += n[1]) : "top" === u ? (a.left += n[0], a.top -= n[1]) : "bottom" === u && (a.left += n[0], a.top += n[1]), e.popper = a, e
    }
    ...
    return fe.Utils = ("undefined" == typeof window ? global : window).PopperUtils, fe.placements = ue, fe.Defaults = {
        placement: "bottom",
        eventsEnabled: !0,
        removeOnDestroy: !1,
        onCreate: function() {},
        ...
        modifiers: {
                ...
                fn: function(e, t) {
                    ...
                    var i = t.priority,
                        ...
                        s = {
                            primary: function(e) {
                                var n = a[e];
                                return a[e] < r[e] && !t.escapeWithReference && (n = V(a[e], r[e])), ae({}, e, n)
                            },
                            secondary: function(e) {
                                var n = "right" === e ? "left" : "top",
                                    o = a[n];
                                return a[e] > r[e] && !t.escapeWithReference && (o = U(a[n], r[e] - ("right" === e ? a.width : a.height))), ae({}, n, o)
                            }
                        };
            ...
            arrow: {
                ...
                fn: function(e, n) {
                    ...
                    var o = e.placement.split("-")[0],
                        ...
                        h = u ? "bottom" : "right",
                        m = T(r)[l];
                    s[h] - m < a[f] && (e.offsets.popper[f] -= a[f] - (s[h] - m)), s[f] + m > a[h] && (e.offsets.popper[f] += s[f] + m - a[h]);
                    var g = s[f] + s[l] / 2 - m / 2,
                        v = t(e.instance.popper, "margin" + c).replace("px", ""),
                        y = g - d(e.offsets.popper)[f] - v;
                    return y = V(U(a[l] - m, y), 0), e.arrowElement = r, e.offsets.arrow = {}, e.offsets.arrow[f] = Math.round(y), e.offsets.arrow[p] = "", e
                },
                element: "[x-arrow]"
            },
            flip: {
                ...
                fn: function(e, t) {
                    ...
                    return a.forEach(function(s, u) {
                        ...
                        (p || v || b) && (e.flipped = !0, (p || v) && (r = a[u + 1]), b && (i = F(i)), e.placement = r + (i ? "-" + i : ""), e.offsets.popper = se({}, e.offsets.popper, E(e.instance.popper, e.offsets.reference, e.placement)), e = D(e.instance.modifiers, e, "flip"))
                    }), e
                },
                behavior: "flip",
                padding: 5,
            ...
            inner: {
                ...
                fn: function(e) {
                    ...
                    return o[a ? "left" : "top"] = i[n] - (s ? o[a ? "width" : "height"] : 0), e.placement = C(t), e.offsets.popper = d(o), e
                }
            },
            hide: {
                order: 800,
            ...
            computeStyle: {
                ...
                fn: function(e, t) {
                    ...
                    var s, u, l = void 0 === a ? t.gpuAcceleration : a,
                        ...
                        v = j("transform");
                    if (u = "bottom" == m ? -f.height + d.bottom : d.top, s = "right" == g ? -f.width + d.right : d.left, l && v) p[v] = "translate3d(" + s + "px, " + u + "px, 0)", p[m] = 0, p[g] = 0, p.willChange = "transform";
                    else {
                        var y = "bottom" == m ? -1 : 1,
                            b = "right" == g ? -1 : 1;
                        p[m] = u * y, p[g] = s * b, p.willChange = m + ", " + g
                    }
                    var w = {
                        "x-placement": e.placement
                    };
                    return e.attributes = se({}, w, e.attributes), e.styles = se({}, p, e.styles), e.arrowStyles = se({}, e.offsets.arrow, e.arrowStyles), e
                },
                gpuAcceleration: !0,
                x: "bottom",
                y: "right"
            ...
            applyStyle: {
                ...
                enabled: !0,
                fn: function(e) {
                    return B(e.instance.popper, e.styles), I(e.instance.popper, e.attributes), e.arrowElement && Object.keys(e.arrowStyles).length && B(e.arrowElement, e.arrowStyles), e
                },
...
function() {
                ...
                u = function(r) {
                    for (var o = Date.now(), i = 0, a = 0, l = 0; l < M.length; l++) {
                        ...
                        var h = c.x * d - c.lastX >> 0,
                            m = c.y * d - c.lastY >> 0;
                        i += h, a += m, c.lastX += h, c.lastY += m, p && (M.splice(l, 1), l--)
                    }
                    s ? window.scrollBy(i, a) : (i && (e.scrollLeft += i), a && (e.scrollTop += a)), t || n || (M = []), M.length ? $(u, e, 1e3 / k.frameRate + 1) : P = !1
                };
            $(u, e, 0), P = !0
        }
    }
    ...
    function n(n) {
        ...
        if (H && (n.wheelDeltaX && h(n.wheelDeltaX, 120) && (a = n.wheelDeltaX / Math.abs(n.wheelDeltaX) * -120), n.wheelDeltaY && h(n.wheelDeltaY, 120) && (u = n.wheelDeltaY / Math.abs(n.wheelDeltaY) * -120)), a || u || (u = -n.wheelDelta || 0), 1 === n.deltaMode && (a *= 40, u *= 40), !k.touchpadSupport && function(e) {
                if (e) return O.length || (O = [e, e, e]), e = Math.abs(e), O.push(e), O.shift(), clearTimeout(E), E = setTimeout(function() {
                    window.localStorage && (localStorage.SS_deltaBuffer = O.join(","))
                }, 1e3), !m(120) && !m(100)
            }(u)) return !0;
        Math.abs(a) > 1.2 && (a *= k.stepSize / 120), Math.abs(u) > 1.2 && (u *= k.stepSize / 120), t(o, a, u), n.preventDefault(), i()
    }
    ...
    function g(e) {
        var t, n;
        return (e *= k.pulseScale) < 1 ? t = e - (1 - Math.exp(-e)) : (e -= 1, t = (n = Math.exp(-1)) + (1 - Math.exp(-e)) * (1 - n)), t * k.pulseNormalize
    }
    ...
    var W, F, $ = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || function(e, t, n) {
        ...
        K = /mobile/i.test(Y),
        G = (X || V) && !K;
    "onwheel" in document.createElement("div") ? F = "wheel" : "onmousewheel" in document.createElement("div") && (F = "mousewheel"), F && G && (f(F, n), f("mousedown", o), f("load", e)), y.destroy = function() {
        w && w.disconnect(), p(F, n), p("mousedown", o), p("keydown", r), p("resize", x), p("load", e)
            ...
            return this.each(function() {
                function o(t) {
                    if (l) {
                        ...
                        e(o).closest("." + r.wrapperClass).is(w.parent()) && i(n, !0), t.preventDefault && !b && t.preventDefault(), b || (t.returnValue = !1)
                    }
                }
                ...
                function i(e, t, n) {
                    ...
                    if (t && (o = parseInt(D.css("top")) + e * parseInt(r.wheelStep) / 100 * D.outerHeight(), o = Math.min(Math.max(o, 0), i), o = e > 0 ? Math.ceil(o) : Math.floor(o), D.css({
                        ...
                        a = Math.min(Math.max(a, 0), i), D.css({
                            top: a + "px"
                        })
                    }
                    w.scrollTop(o), w.trigger("slimscrolling", ~~o), s(), u()
                }

                function a() {
                    h = Math.max(w.outerHeight() / w[0].scrollHeight * w.outerHeight(), y), D.css({
                        height: h + "px"
                    });
                ...
                function s() {
                    ...
                    g = m, h >= w.outerHeight() ? b = !0 : (D.stop(!0, !0).fadeIn("fast"), r.railVisible && k.stop(!0, !0).fadeIn("fast"))
                }
                ...
                if (w.parent().hasClass(r.wrapperClass)) {
                    ...
                    if (D = w.siblings("." + r.barClass), k = w.siblings("." + r.railClass), a(), e.isPlainObject(n)) {
                        if ("height" in n && "auto" == n.height) {
                            ...
                            w.parent().css("height", T), w.css("height", T)
                        } else if ("height" in n) {
                            var C = n.height;
                        ...
                        else if ("destroy" in n) return D.remove(), k.remove(), void w.unwrap();
                        i(x, !1, !0)
                    }
                    ...
                    k.css(N), D.css(N), w.wrap(E), w.parent().append(D), w.parent().append(k), r.railDraggable && D.bind("mousedown", function(n) {
                        var r = e(document);
                        return f = !0, t = parseFloat(D.css("top")), pageY = n.pageY, r.bind("mousemove.slimscroll", function(e) {
                            currTop = t + e.pageY - pageY, D.css("top", currTop), i(0, D.position().top, !1)
                        }), r.bind("mouseup.slimscroll", function(e) {
                            f = !1, u(), r.unbind(".slimscroll")
                        }), !1
                        ...
                        b || e.originalEvent.preventDefault(), e.originalEvent.touches.length && (i((d - e.originalEvent.touches[0].pageY) / r.touchScrollStep, !0), d = e.originalEvent.touches[0].pageY)
                    }), a(), "bottom" === r.start ? (D.css({
                        top: w.outerHeight() - D.outerHeight()
                    }), i(0, !0)) : "top" !== r.start && (i(e(r.start).position().top, null, !0), r.alwaysVisible || D.hide()), S = this, window.addEventListener ? (S.addEventListener("DOMMouseScroll", o, !1), S.addEventListener("mousewheel", o, !1)) : document.attachEvent("onmousewheel", o)
                }
            }), this
        }
    }), e.fn.extend({
