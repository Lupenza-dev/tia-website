            ...
            function getRemoveButtonStructure(type) {
                ...
                switch (type) {
                    case 'table':
                        ...
                        break;
                    default:
                        output = '<button type="button" class="' + generatedSelectorClassForRemoveBtn + ' metal-btn-remove btn btn-danger btn-outline-danger' + ((opt.btnRemoveClass && typeof opt.btnRemoveClass !== 'number') ? opt.btnRemoveClass : '') + '" style="margin-bottom: 20px;height:45px; margin-top: 25px" data-metal-ref="' + generatedSelectorClass + '">' + iconContent + currentBtnRemoveText + '</button>';
                }
