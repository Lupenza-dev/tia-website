				...
				if (node['type'] == 'member') {
					...
					grid.addWidget('<div data-gs-type="member"'+
								...
								'<div class=" grid-stack-item-content row d-flex px-3 justify-content-center text-center my-3">'+
									'<div class="col-12"><img src="'+window.ajaxBasePath+'/uploads/administration/'+node['image']+'" class="w-100"/></div>'+
		...
		$('.add-grid-member').on('click', function(){
			...
			for (var i = 0; i < r.length; i++) {
				...
				grid.addWidget('<div data-gs-type="member"'+
							...
							'<div class="grid-stack-item-content row d-flex px-3 justify-content-center text-center my-3">'+
								'<div class="col-12"><img src="'+window.ajaxBasePath+'/uploads/administration/'+keyword['photo_url']+'" class="w-75"/></div>'+
