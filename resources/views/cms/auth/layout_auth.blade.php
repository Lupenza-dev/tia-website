...
<html lang="en" dir="ltr">
  ...
  <body >
    <div class="container login-container">
      <div class="row">
        <div class="col-md-7 py-3 h-100 left-container text-white" style="background-image: url('{{asset('admin/images/tz_flag.jpg')}}')">
          <h1> <b>{{ label('lbl_site_title_short')}} </b> </h1>
          <h6> <i>Content Management System</i> </h6>
        </div>

        <div class="col-md-4 mx-auto">
            <div class="col-md-12">
              @empty ($logos->login_logo_url)
                <div class="profile-img"> <img src="{{ asset('admin/images/logo/emblem.png') }}"> </div>
                @else
                  <div class="profile-img"> <img src="{{ asset('uploads/logos/'.$logos->login_logo_url) }}"> </div>
              @endempty
