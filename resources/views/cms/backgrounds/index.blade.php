...
{{--										<img class="img-fluid" src="{{asset($backgrounds->main_bg)}}" alt="Main Background" style="max-height:200px">--}}
{{--									</div>--}}
									<div class="py-3">
										<h5>BANNER BACKGROUND</h5>
										<img class="img-fluid" src="{{asset($backgrounds->banner_bg)}}" alt="Banner Background" style="max-height:100px">
									</div>

{{--									@if($backgrounds->second_bg)--}}
{{--										<div class="py-3">--}}
{{--											<h5>SECOND HOMEPAGE BACKGROUND</h5>--}}
{{--											<img class="img-fluid" src="{{asset($backgrounds->second_bg)}}" alt="Second Background" style="max-height:200px">--}}
{{--										</div>--}}
{{--									@endif--}}
