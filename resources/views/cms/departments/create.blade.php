					...
					<div class="row align-items-center">
							<div class="col-md-12">
									...
									<ul class="breadcrumb">
											...
											<li class="breadcrumb-item"><a href="{{ url('/cms/departments') }}">Departments</a></li>
											<li class="breadcrumb-item"><a href="javascript:">Create Department</a></li>
									</ul>
							</div>
					</div>
			</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="card">
							...
							<div class="card-body">
								{!! Form::open(['route' => 'cms.departments.index', 'files' => true]) !!}
								...
								<div class="card-block px-0 mt-3">
									<div class="col-md-12">
										...
										<div class="col-12 px-0 form-group">
											...
											{!! Form::text('dept_code',null,['class'=>'form-control', 'placeholder' => 'e.g. DPT-001']) !!}
										</div>
										<div class="col-12 px-0 form-group">
