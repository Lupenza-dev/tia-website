					...
					<div class="row align-items-center">
							<div class="col-md-12">
									...
									<ul class="breadcrumb">
											...
											<li class="breadcrumb-item"><a href="javascript:">Edit Event</a></li>
									</ul>
							</div>
					</div>
			</div>
	...
	<div class="main-body">
			<div class="page-wrapper">
				<div class="row">
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header" > <h5>Edit Event</h5></div>
							<div class="card-body">
                {!! Form::model($event, ['route' => ['cms.events.update', $event->id], 'files' => true, 'method' => 'PATCH']) !!}
								@include('cms.includes.cropimage',['img' => asset('/uploads/events/'.$event->photo_url)])
