											...
											<tr class="shadow-on-hover">
												<td>
													@empty ($event->photo_url)
														<img src="{{ asset('/site/images/flag_covers/1.jpg') }}" style="max-height:40px !important;">
													@else
														<img src="{{ asset('/uploads/events/'.$event->photo_url) }}" style="max-height:40px !important;">
													@endempty
												</td>
