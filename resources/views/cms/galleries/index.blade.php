  					...
  					<div class="row align-items-center">
  							<div class="col-md-7">
  									...
  									<ul class="breadcrumb">
  											...
  											<li class="breadcrumb-item"><a href="javascript:">Galleries</a></li>
  									</ul>
  							</div>
  	...
  	<div class="main-body">
            ...
            @else
              @foreach($types as $title=>$type)
      					...
      					<div class="col-md-12">
      						<div class="card">
      							<div class="card-header text-capitalize" > <h5> {{$title}} Galleries</h5></div>
      							<div class="card-body">
                      <div class="row grid">
                          ...
                          @foreach($type as $key => $gallery)                              
                            ...
                            <figure class="effect-kira">
                              ...
                              @if (count($gallery->photos) > 1 && ($title == 'photos'))
                                <img src="{{ asset($gallery->photos->first()->image())}}" class="w-100" style="min-height: 150px">
                              @else
                                <img src="{{ asset('admin/images/1.jpg')}}" class="w-100" style="min-height: 150px">
                              @endif
                              <figcaption>
                              <h2>
                                @if ($title == 'photos')
                                  ...
                                  @else
                                    {{ number_format(count($gallery->videos))}} <i class="feather icon-video"></i>
                                @endif
                                </h2>
                                <p class="text-center">
