...
@section('content')
  					...
  					<div class="row align-items-center">
  							<div class="col-md-7">
  									...
  									<ul class="breadcrumb">
  											...
  											<li class="breadcrumb-item"><a href="javascript:">Video Galleries</a></li>
  									</ul>
  							</div>
  	...
  	<div class="main-body">
            ...
            @else
      					...
      					<div class="col-md-12">
      						<div class="card">
      							<div class="card-header text-capitalize" > <h5> Video Galleries</h5></div>
      							<div class="card-body">
                      <div class="row grid">
                          ...
                          @foreach($galleries as $key => $gallery)
                            ...
                            <figure class="effect-kira">
                                <h6>{{ $gallery->title }}</h6>
                                <img src="{{ asset('admin/images/1.jpg')}}" class="w-100">
                              <figcaption>
                              <h2>
