...
<div class="col-md-12">
  <div class="col-12 px-0 form-group">
    {!! Form::label('category_id', 'The Product Category') !!}
    {!! Form::select('category_id', $categories, null, array('class' => 'form-control select2')) !!}
  </div>
  
  <div class="col-12 px-0 form-group">
      {!! Form::label('title_en', 'Product Title in English') !!}
      {!! Form::text('title_en',null,['class'=>'form-control']) !!}
  </div>

  <div class="col-12 px-0 form-group">
    {!! Form::label('title_sw', 'Product Title in Swahili') !!}
    {!! Form::text('title_sw',null,['class'=>'form-control']) !!}
  </div>

  <div class="col-12 px-0 form-group">
      {!! Form::label('summary_en', 'Product Summary in English') !!}
      {!! Form::textarea('summary_en', null, ['class' => 'form-control','rows'=>'3','cols'=>'80']) !!}
  </div>

  <div class="col-12 px-0 form-group">
    {!! Form::label('summary_sw', 'Product Summary in Swahili') !!}
    {!! Form::textarea('summary_sw', null, ['class' => 'form-control','rows'=>'3','cols'=>'80']) !!}
  </div>

  <div class="col-12 px-0 form-group">
    {!! Form::label('content_en', '[optional] Product Content in English') !!}
    {!! Form::textarea('content_en',null, ['id' => 'redactor_en','class'=>'form-control']) !!}
  </div>

  <div class="col-12 px-0 form-group">
    {!! Form::label('content_sw', '[optional] Product Content in Swahili') !!}
