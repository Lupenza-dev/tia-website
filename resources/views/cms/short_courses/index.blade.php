					...
					<div class="row align-items-center">
							<div class="col-md-7">
									<div class="page-header-title">
											<h5 class="m-b-10">Short Courses</h5>
									</div>
									<ul class="breadcrumb">
											<li class="breadcrumb-item"><a href="{{ url('/cms') }}"><i class="feather icon-home"></i></a></li>
											<li class="breadcrumb-item"><a href="javascript:">Site Contents</a></li>
											<li class="breadcrumb-item"><a href="javascript:">Short Courses</a></li>
											<li class="breadcrumb-item"><a href="javascript:">Short Courses</a></li>
									</ul>
							</div>
				...
				<div class="row">
					...
					<div class="col-md-8">
						<div class="card">
							...
							<div class="card-body">
								{!! Form::open(['route' => 'cms.short_courses.index']) !!}

									@include('cms.short_courses._form', ['submitButton' => "Save"])
					...
					<div class="col-md-4">
						<div class="card">
							<div class="card-header" > <h5>List Of Short Courses</h5></div>
							<div class="card-body">
								@if($courses->count() == 0)
									<div class="col-md-12">
										...
										<div class="col-md-12 col-sm-12">
											<div class="cf nestable-lists">
												<div class="dd" id="nestable" ajax-url="/cms/ajax_menu_update/Course">
													<ol class="dd-list">
														{!! recursiveOtherLinksMenu('0','short_courses') !!}
													</ol>
									        ...
									        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
									            <div class="modal-content">
									                ...
									                <div class="modal-body">
																		{!! Form::model($course, ['route' => ['cms.short_courses.update', $course->id], 'method' => 'PATCH']) !!}
