						...
						@foreach($galleries as $gallery)
							@foreach ($gallery->photos as $m) 
								<div class="col-6 col-md-3 col-lg-2 py-2">
									<img class="w-100 cursor-pointer" src="{{asset($m->image())}}" ondblclick="loadFile('{{asset($m->image())}}');">
								</div>
							@endforeach
						@endforeach
					</div>
				...
				<div class="tab-pane fade" id="pills-image2" role="tabpanel" aria-labelledby="pills-image2-tab">
					<div class="row mx-0">
						@foreach($uploaded_images as $image)
							<div class="col-6 col-md-3 col-lg-2 py-2">
								<img class="w-100 cursor-pointer" src="{{$image['link']}}" ondblclick="loadFile('{{$image['link']}}');">
							</div>
						@endforeach
					</div>
				</div>
