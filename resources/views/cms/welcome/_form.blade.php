<div class="row">
    ...
    <div class="alert alert-warning col-12" role="alert">
      ...
      <span class='form_error'>{!! $errors->first('mission_sw') !!}</span> <br/>
      <span class='form_error'>{!! $errors->first('mission_en') !!}</span> <br/>
      <span class='form_error'>{!! $errors->first('vision_sw') !!}</span> <br/>
      <span class='form_error'>{!! $errors->first('vision_en') !!}</span> <br/>
    ...
    @endif
     ...
     {{-- <div class="form-group col-12">
       {!! Form::label('summary_sw', 'Quote / Slogan in Swahili') !!}
       {!! Form::text('summary_sw', null, ['class' => 'form-control']) !!}
     </div> --}}
     
     {{-- <div class="form-group col-12">
       {!! Form::label('summary_en', 'Quote / Slogan in English') !!}
       {!! Form::text('summary_en', null, ['class' => 'form-control']) !!}
     </div> --}}
