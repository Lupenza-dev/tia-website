              ...
              <div class="col-12 px-0 mt-4">
                ...
                <div class="row justify-content-center">
                      ...
                      <div class="col-xs-12 col-sm-6 col-md-3 text-center">
                        <div class="">
                          <img src="{{ asset('/uploads/administration/'.$president->photo_url) }}"
                          alt="{!! $president->salutation !!} {!! $president->fullname !!}" class="img-fluid w-75 administration-img-profile">
                        </div>
                        <div class="col-12 mt-2">
                          <a href="#" data-toggle="modal" data-target="#presidentLevel">
                            <h6 class="">{!! $president->salutation !!} {!! $president->fullname !!}</h6>
                            <p class="mt-0"><b>{!! $president->title !!}</b></p>
                          </a>
                        </div>
                      </div>


                      <div class="modal fade" id="presidentLevel" tabindex="-1" role="dialog" aria-hidden="true">
                          <div class="modal-dialog modal-dialog-centered modal-lg" role="document" style="max-width:85%">
                              <div class="modal-content letter">
                                  <div class="modal-header">
                                      <h5 class="modal-title" > {!! $president->title !!} </h5>
                                  ...
                                  <div class="modal-body">
                                          ...
                                          <div class="row">
                                            <div class="col-md-4 col-xs-12">
                                                <img src="{{ asset('/uploads/administration/'.$president->photo_url) }}"
                                                alt="{!! $president->salutation !!} {!! $president->fullname !!}" class="img-fluid w-100 administration-img-profile">
                                            </div>

                                            <div class="col-md-8 col-xs-12">
                                              <div class="">
                                                <h5 class="title mb-2"> {!! $president->salutation !!} {!! $president->fullname !!}</h5>
                                              </div>
                ...
                <div class="row justify-content-center">
                  ...
                  @foreach ($administration_level_2 as $key => $member)
                        <div class="col-xs-12 col-sm-6 col-md-3 text-center">
                          <div class="">
                          ...
                          <div class="col-12 mt-2">
                            <a href="#"  data-toggle="modal" data-target="{{'#administrationSecondLevel'.$key}}">
                        ...
                        <div class="modal fade" id="{{'administrationSecondLevel'.$key}}" tabindex="-1" role="dialog" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document" style="max-width:85%">
                                                        <div class="modal-content letter">
                                                            <div class="modal-header">
                ...
                <div class="row justify-content-start">
                  ...
                  @foreach ($administration_level_3 as $key => $member)
                        <div class="col-xs-12 col-sm-6 col-md-3 text-center">
                          <div class="">
                            <img src="{{ asset('/uploads/administration/'.$member->photo_url) }}"
                              alt="{!! $member->salutation !!} {!! $member->fullname !!}" class="img-fluid w-75 administration-img-profile">
