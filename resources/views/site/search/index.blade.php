  ...
  <div class="col-12 px-0 px-xl-5">
    <div class="row mx-0">
      <div class="col-lg-12 px-0 my-2 page-content">
        ...
        <div class="row mx-0">
          <div class="col-12 col-md-4 px-0 pb-3">
          ...
          <div class=" col-12 col-md-8 bg-white  px-lg-5 page-content" >
            <div class="content-heading text-primary font-weight-bold">
              <h5 class="">               
                      ...
                      <div class="mt-3">
                        @foreach($announcementResults as $announcement)
                          <a href="{!! URL::to('announcements', $announcement->slug) !!}" class="border-bottom gray-border d-block mb-3">
                            <h6 class="mb-1 text-primary bold-600 search-highlight">{{$announcement->name }}</h6>                                  
