...
Route::middleware(['auth','checked','cors'])->prefix('cms')->name('cms.')->group(function(){
    ...
    Route::resource('passengers', 'cms\PassengersController');
    ...
    Route::resource('complaints', 'cms\ComplaintsController');
    ...
    // Route::resource('customer_centers', 'cms\CustomerCentersController');
    ...
    Route::resource('campuses', 'cms\CampusController');
    ...
    Route::resource('long_courses', 'cms\LongCourseController');
    // Route::resource('sales_points', 'cms\SalesPointsController');
